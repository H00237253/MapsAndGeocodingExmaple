package ae.ac.hct.tkamal.dbmonmapapp;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dbm = new LatLng(25.108548, 55.393198);
        mMap.addMarker(new MarkerOptions().position(dbm).title("DBM"));

        // Add a marker in Sydney and move the camera
        LatLng zu = new LatLng(25.1086375, 55.3858693);
        mMap.addMarker(new MarkerOptions().position(zu).title("Zayed Uni"));

        mMap.setMinZoomPreference(15);

        mMap.moveCamera(CameraUpdateFactory.newLatLng(dbm));
    }
